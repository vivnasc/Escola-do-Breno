...
const EXPERIMENTS = [
  ...
  {
    title: 'Arco-Íris',
    question: 'O que forma um arco-íris?',
    emoji: '🌈',
    minLevel: 4,
    options: [
      { text: 'A luz do sol a passar por gotas de chuva', emoji: '☀️💧', correct: true },
      { text: 'Tintas que caem das nuvens', emoji: '🎨', correct: false },
      { text: 'As nuvens a brilhar', emoji: '☁️', correct: false },
    ],
    fact: 'A luz branca do sol contém todas as cores! Quando passa por gotas de chuva, separa-se em 7 cores: vermelho, laranja, amarelo, verde, azul, anil e violeta.',
  },
  {
    title: 'Sementes',
    question: 'De onde vem uma árvore grande?',
    emoji: '🌳',
    minLevel: 1,
    options: [
      { text: 'De uma semente pequena que germinou', emoji: '🌱', correct: true },
      { text: 'Nasce grande de repente', emoji: '💥', correct: false },
      { text: 'Cai do céu', emoji: '☁️', correct: false },
    ],
    fact: 'Todas as árvores começam como sementes minúsculas! Um carvalho enorme pode ter nascido de uma bolota mais pequena que o teu dedo. Precisa de anos de sol, água e terra para crescer.',
  },
  {
    title: 'Ar',
    question: 'O ar é feito de quê?',
    emoji: '💨',
    minLevel: 5,
    options: [
      { text: 'Principalmente azoto e oxigénio', emoji: '🌬️', correct: true },
      { text: 'Apenas oxigénio', emoji: 'O₂', correct: false },
      { text: 'Nada, o ar está vazio', emoji: '❌', correct: false },
    ],
    fact: 'O ar é uma mistura de gases: 78% azoto, 21% oxigénio e 1% de outros gases. Não o vemos, mas podemos sentir quando o vento sopra!',
  },
  {
    title: 'Sombras',
    question: 'Porque temos sombra quando está sol?',
    emoji: '🏃‍♂️',
    minLevel: 2,
    options: [
      { text: 'Porque o corpo bloqueia a luz e cria uma zona escura', emoji: '⬛', correct: true },
      { text: 'Porque o chão é especial', emoji: '🟫', correct: false },
      { text: 'Porque o sol pinta o chão', emoji: '🎨', correct: false },
    ],
    fact: 'A luz viaja em linha recta. Quando algo bloqueia a luz, cria uma sombra. De manhã e ao fim da tarde as sombras são longas porque o sol está baixo. Ao meio-dia são curtas!',
  },
  {
    title: 'Cristais de Gelo',
    question: 'Os flocos de neve são todos iguais?',
    emoji: '❄️',
    minLevel: 6,
    options: [
      { text: 'Não, cada floco de neve é único e diferente', emoji: '❄️', correct: true },
      { text: 'Sim, são todos iguais', emoji: '=', correct: false },
      { text: 'Existem apenas 3 tipos', emoji: '3️⃣', correct: false },
    ],
    fact: 'Cada floco de neve é um cristal de gelo único! A forma depende da temperatura e humidade enquanto cai. Todos os flocos têm 6 lados, mas os padrões são sempre diferentes.',
  },
  {
    title: 'Lua',
    question: 'A Lua tem luz própria?',
    emoji: '🌙',
    minLevel: 3,
    options: [
      { text: 'Não, reflecte a luz do Sol', emoji: '🔦', correct: true },
      { text: 'Sim, é como uma lâmpada', emoji: '💡', correct: false },
      { text: 'Sim, mas só de noite', emoji: '🌑', correct: false },
    ],
    fact: 'A Lua não tem luz própria — é como um espelho gigante que reflecte a luz do Sol! As fases da Lua (cheia, nova, quarto) acontecem porque vemos diferentes partes iluminadas.',
  },
  {
    title: 'Ecossistemas',
    ...
    minLevel: 7,
    options: [
      { text: 'Um conjunto de seres vivos e o ambiente onde vivem, todos ligados entre si', emoji: '🔗', correct: true },
      { text: 'Um tipo de parque natural', emoji: '🏞️', correct: false },
      { text: 'Uma máquina que limpa o ar', emoji: '🏭', correct: false },
    ],
    fact: 'Um ecossistema inclui todos os seres vivos (plantas, animais, fungos, bactérias) e o ambiente (água, solo, clima). Tudo está ligado: se uma espécie desaparece, todo o sistema é afectado!',
  },
  {
    title: 'Fotossíntese',
    question: 'As plantas respiram?',
    emoji: '🌿',
    minLevel: 5,
    options: [
      { text: 'Sim, absorvem CO₂ e libertam oxigénio durante o dia', emoji: '💨', correct: true },
      { text: 'Não, as plantas não precisam de ar', emoji: '❌', correct: false },
      { text: 'Sim, mas só de noite', emoji: '🌙', correct: false },
    ],
    fact: 'As plantas fazem o contrário de nós: absorvem dióxido de carbono (CO₂) e libertam oxigénio (O₂). Uma única árvore pode produzir oxigénio suficiente para 2 pessoas por ano!',
  },
  {
    title: 'Terramoto',
    question: 'O que provoca um terramoto?',
    emoji: '🌍',
    minLevel: 8,
    options: [
      { text: 'O movimento das placas tectónicas da Terra', emoji: '🔀', correct: true },
      { text: 'O vento muito forte', emoji: '💨', correct: false },
      { text: 'A chuva a bater no chão', emoji: '🌧️', correct: false },
    ],
    fact: 'A superfície da Terra é formada por placas gigantes que se movem lentamente. Quando estas placas colidem ou deslizam, a energia libertada causa terramotos! A maioria são tão pequenos que não sentimos.',
  },
  {
    title: 'Predadores e Presas',
    question: 'Porque é que as zebras têm riscas?',
    emoji: '🦓',
    minLevel: 6,
    options: [
      { text: 'Para confundir os predadores quando correm em grupo', emoji: '🏃', correct: true },
      { text: 'Porque gostam de moda', emoji: '👗', correct: false },
      { text: 'Para se aquecerem', emoji: '🔥', correct: false },
    ],
    fact: 'As riscas das zebras criam uma ilusão óptica quando o grupo corre junto — é difícil para o leão identificar uma zebra individual! As riscas também podem ajudar a repelir moscas.',
  },
]
