...
const SCENARIOS = [
  ...
  },
  {
    city: 'Helsínquia',
    temp: -2,
    weather: 'Frio com neve fraca',
    weatherEmoji: '🌨️',
    correctKit: 'neve',
    minLevel: 5,
    options: [
      { id: 'neve', label: 'Casaco quente, gorro, luvas e botas de neve', emoji: '🧥🧤🥾' },
      { id: 'leve', label: 'T-shirt e sandálias', emoji: '👕🩴' },
      { id: 'chuva', label: 'Impermeável leve', emoji: '🧥' },
    ],
  },
  {
    city: 'Bogotá',
    temp: 14,
    weather: 'Fresco e com aguaceiros',
    weatherEmoji: '🌦️',
    correctKit: 'fresco-chuva',
    minLevel: 6,
    options: [
      { id: 'fresco-chuva', label: 'Casaco leve, guarda-chuva e calças compridas', emoji: '🧥☂️👖' },
      { id: 'pesado', label: 'Casaco grosso de inverno', emoji: '🧥🧣' },
      { id: 'leve', label: 'T-shirt e calções', emoji: '👕🩳' },
    ],
  },
  {
    city: 'Singapura',
    temp: 31,
    weather: 'Muito húmido e quente',
    weatherEmoji: '🌡️',
    correctKit: 'tropical',
    minLevel: 7,
    options: [
      { id: 'tropical', label: 'Roupa muito leve de algodão e garrafa de água', emoji: '👕💧' },
      { id: 'pesado', label: 'Casaco de lã e cachecol', emoji: '🧥🧣' },
      { id: 'neve', label: 'Equipamento de inverno', emoji: '⛷️' },
    ],
  },
  {
    city: 'Cidade do Cabo',
    temp: 20,
    weather: 'Vento forte e sol',
    weatherEmoji: '💨☀️',
    correctKit: 'vento-sol',
    minLevel: 8,
    options: [
      { id: 'vento-sol', label: 'Corta-vento, protector solar e óculos de sol', emoji: '🧥🧴🕶️' },
      { id: 'pesado', label: 'Casaco grosso e gorro', emoji: '🧥🧢' },
      { id: 'neve', label: 'Roupa para neve', emoji: '⛷️' },
    ],
  },
  {
    city: 'Ancara',
    temp: 5,
    weather: 'Frio seco e nublado',
    weatherEmoji: '🌥️',
    correctKit: 'frio-seco',
    minLevel: 9,
    options: [
      { id: 'frio-seco', label: 'Casaco quente, cachecol e calças compridas', emoji: '🧥🧣👖' },
      { id: 'leve', label: 'T-shirt e calções', emoji: '👕🩳' },
      { id: 'tropical', label: 'Roupa leve de algodão', emoji: '👕' },
    ],
  },
  {
    city: 'Ushuaia',
    temp: 0,
    weather: 'Gelado com vento polar',
    weatherEmoji: '🥶💨',
    correctKit: 'artico',
    minLevel: 9,
    options: [
      { id: 'artico', label: 'Várias camadas, casaco corta-vento, luvas e gorro', emoji: '🧥🧤🧣🧢' },
      { id: 'leve', label: 'Camisola fina e sandálias', emoji: '👕🩴' },
      { id: 'chuva', label: 'Apenas impermeável', emoji: '🧥' },
    ],
  },
]
