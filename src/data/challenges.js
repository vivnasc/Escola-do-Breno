...
const CHALLENGE_SETS = [
  [
    {
      ...
      icon: '🗣️',
      description: 'Aprende 5 palavras novas em ingles',
      target: 5,
      type: 'words',
      reward: 10,
      campo: 'campo1',
    ...
    {
      id: 'wc-math-3',
      name: 'Matematico de Ouro',
      icon: '🔢',
      description: 'Completa 3 actividades de matematica',
      target: 3,
  ...
  [
    {
      id: 'wc-vocab-8',
      name: 'Super Vocabulario',
      icon: '📚',
      description: 'Aprende 8 palavras novas em ingles',
      target: 8,
      type: 'words',
      reward: 15,
      campo: 'campo1',
  ...
  [
    ...
    {
      id: 'wc-vida-2',
      name: 'Campeao da Vida',
      icon: '🤝',
      description: 'Completa 2 actividades de competencias sociais',
      target: 2,
  ...
  [
    {
      ...
      icon: '🏆',
      description: 'Aprende 10 palavras em ingles',
      target: 10,
      type: 'words',
      reward: 18,
      campo: 'campo1',
