  ...
  football: {
    ...
    color: {
      ...
      items: [
        ...
        { name: 'Seleccao', detail: 'Mocambique', colors: ['green', 'red'] },
      ],
    },
  ...
  dinosaurs: {
    ...
    color: {
      ...
      items: [
        ...
        { name: 'Brachiosaurus', detail: 'Jurassico', colors: ['green', 'brown'] },
        { name: 'Parasaurolophus', detail: 'Cretaceo', colors: ['blue', 'green'] },
        { name: 'Velociraptor', detail: 'Cretaceo', colors: ['orange', 'brown'] },
        { name: 'Archaeopteryx', detail: 'Jurassico', colors: ['black', 'yellow'] },
        { name: 'Mosasaurus', detail: 'Cretaceo', colors: ['blue', 'black'] },
        { name: 'Iguanodon', detail: 'Cretaceo', colors: ['green', 'yellow'] },
      ],
    },
  ...
  space: {
    ...
    color: {
      ...
      items: [
        ...
        { name: 'Cometa Halley', detail: 'Espaco', colors: ['white', 'blue'] },
        { name: 'Estacao Espacial', detail: 'Orbita', colors: ['white', 'black'] },
        { name: 'Estrela Cadente', detail: 'Espaco', colors: ['yellow', 'white'] },
        { name: 'Buraco Negro', detail: 'Espaco', colors: ['black', 'purple'] },
      ],
    },
  ...
  music: {
    ...
    color: {
      ...
      items: [
        ...
        { name: 'Bateria', detail: 'Percussao', colors: ['red', 'black'] },
        { name: 'Harpa', detail: 'Classico', colors: ['yellow', 'brown'] },
        { name: 'Acordeao', detail: 'Folk', colors: ['red', 'white'] },
        { name: 'Tuba', detail: 'Classico', colors: ['yellow', 'white'] },
